...
@Composable
fun PetSelectTopAppBar(onBackClick: () -> Unit) {
    Column {
        CenterAlignedTopAppBar(
            title = {
                Text(
                    text = stringResource(R.string.diagnosis_select_top_bar),
            ...
            navigationIcon = {
                Box(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.diagnosis_select_top_bar_navigation_description),
                        tint = Gray300,
...
private fun PetSelectTopAppBarPreview() {
    PpoPpiTheme {
        PetSelectTopAppBar(onBackClick = {})
    }
}
