...
@Composable
fun CameraTopAppBar(onBackClick: () -> Unit) {
    Column {
        CenterAlignedTopAppBar(
            title = {
                Text(
                    text = stringResource(R.string.diagnosis_camera_top_bar),
            ...
            navigationIcon = {
                Box(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.diagnosis_camera_top_bar_navigation_description),
                        tint = Gray300,
...
private fun CameraTopAppBarPreview() {
    PpoPpiTheme {
        CameraTopAppBar(onBackClick = {})
    }
}
